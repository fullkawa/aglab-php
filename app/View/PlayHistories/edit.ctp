...
<?php echo $this->Form->create('PlayHistory'); ?>
	<fieldset>
		<legend><?php echo __('Edit Play History'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('PlayHistory.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('PlayHistory.id'))); ?></li>
