...
<?php echo $this->Form->create('GameRule'); ?>
	<fieldset>
		<legend><?php echo __('Edit Game Rule'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('GameRule.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('GameRule.id'))); ?></li>
