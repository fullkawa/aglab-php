...
<?php echo $this->Form->create('Repdata'); ?>
	<fieldset>
		<legend><?php echo __('Edit Repdata'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Repdata.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Repdata.id'))); ?></li>
